...
const eco = new Economy({
    ...
    hourlyAmount: 5, // How much they get each time they do /hourly
    dailyAmount: 150, // How much they get each time they do /daily
    workAmount: [25, 250], // How much they get each time they work [Min, Max]
    weeklyAmount: 1500, // How much they get each time they do /weekly
    monthlyAmount: 6000, // How much they get each time they do /monthly
    ...
    dateLocale: 'en', // What country are the dates based on?
